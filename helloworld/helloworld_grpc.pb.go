...
const (
	Greet_SayHello_FullMethodName = "/helloworld.Greet/SayHello"
)
...
func (c *greetClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (UnimplementedGreetServer) SayHello(context.Context, *HelloRequest) (*HelloReply, error) {
